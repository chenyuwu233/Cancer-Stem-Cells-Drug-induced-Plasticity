...
function [Theta,p] = coeff_reshape(theta,cmd1,cmd2,s)
    switch cmd2
        case 'Gen'
            switch cmd1 
                case {'Linear_switching','Linear_switching_EP'}
                    ...
                    p     = Theta(:,1)';
                    Theta(:,1) = [];
                case {'Single_Broad','Hill2_switching_2','Single_Broad_d','Hill2_death_2','Multi_Selective','Multi_Selective_d',...
                        'Single_Broad_EP','Hill2_switching_2_EP','Multi_All_nu','Hill2_death_2_EP','Multi_Selective_EP','Multi_Selective_d_EP'}
                ...
                case {'Hill2_switching_Hill2_death_i','Multi_Broad',...
                    ...
                    Theta(:,1) = [];
%                 case {'Multi_All'}
%                     if length(theta) ~= s*(s+10)
%                         warning('The dimension is not match.')
%                         pause
%                     end
%                     Theta = reshape(theta,[s+10,s])';
%                     p     = Theta(:,1)';
%                     Theta(:,1) = [];
            end
        ...
        case 'Like'
            switch cmd1
                case {'Linear_switching','Linear_switching_EP'}
                    ...
                    Theta(:,1) = [];
                case {'Single_Broad','Hill2_switching_2','Single_Broad_d','Hill2_death_2','Multi_Selective','Multi_Selective_d',...
                        'Single_Broad_EP','Hill2_switching_2_EP','Hill2_death_EP','Hill2_death_2_EP','Multi_Selective_EP','Multi_Selective_d_EP'}
                    if length(theta) ~= s*(s+4)
                        warning('The dimension is not match.')
                        pause
                    end
